...
const CASES = [
  {
    title: '',
    type: 'Популярная федеральная сеть фитнес-клубов',
    image: '/images/case-ddx-new.jpg',
    problem: 'Несоблюдение стандартов чистоты, репутационные риски, отток клиентов.',
    solution: 'Выстроили соблюдение внутренних стандартов клуба, закрепили стабильный обученный персонал. Жалобы от гостей — ноль.',
    results: [],
  },
  {
    title: '',
    ...
    problem: 'Постоянная ротация клинеров, непрерывное обучение новых сотрудников.',
    solution: 'Стабильный штат с медкнижками и полным пакетом документов. Замены — в день обращения. Фиксированная цена, безналичный расчёт.',
    results: [],
  },
  {
    title: '',
