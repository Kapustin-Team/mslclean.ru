...
const CASES = [
  {
    title: '',
    type: 'Фитнес-клуб',
    image: '/images/case-ddx-new.jpg',
    problem: 'Несоблюдение стандартов чистоты портит впечатление гостей и репутацию клуба.',
    solution: 'Мы поддерживаем идеальную чистоту, как в день открытия. Наши клинеры проходят обучение и знают все внутренние правила клуба, поэтому жалобы от посетителей просто исчезают.',
    results: [],
  },
  {
    title: '',
    type: 'Ресторанная сеть',
    image: '/images/case-salad-2.jpg',
    problem: 'Постоянная текучка кадров, приходится заново обучать новых сотрудников, что влияет на качество уборки и стабильность.',
    solution: 'Формируем постоянную, обученную команду с медицинскими книжками и всеми документами. При необходимости оперативно предоставляем замену. Работаем по безналу и фиксированной ежемесячной цене, без сюрпризов и с постоянным качеством.',
    results: [],
  },
  {
    title: '',
    type: 'Крупный объект',
    image: '/images/case-national-new.jpg',
    problem: 'Большая территория, много персонала и строгие требования по безопасности и санитарным нормам. Нужно быстро реагировать на неожиданные ситуации и проверки.',
    solution: 'Наши специалисты обеспечивают бесперебойную уборку и строгое соблюдение всех норм. В случае повышенной нагрузки усиливаем команду в тот же день. Работы выполняются без сбоев, в полном соответствии с требованиями и стандартами.',
    results: [],
  },
]
