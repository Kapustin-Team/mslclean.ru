...
const CASES = [
  ...
  {
    title: '',
    type: 'Крупный государственный объект',
    image: '/images/case-national-new.jpg',
    problem: 'Масштабный объект с командой из 13 человек, строгие требования СанПиН, повышенная ответственность',
    solution: 'Бесперебойная работа в полном соответствии с нормами. Усиление штата — день в день при любом форс-мажоре.',
    results: [],
  },
]
